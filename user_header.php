		...
		<aside class="sidebar">
			...
			<div class="user-info">
					<figure class="rounded-image profile__img">
						<a href="user_dashbord.php"><img class="media-object" src="img/profile.png" alt="user"></a>
					</figure>
					<h2 class="user-info__name"><?php echo $_SESSION['username'];?></h2>
					<h3 class="user-info__role">User </h3>
					
				</div> <!-- /user-info -->

				<ul class="main-nav">
					<li class="main-nav--active">
						<a class="main-nav__link" href="user_dashbord.php">
					...
					<li class="main-nav--collapsible">
						...
						<ul class="main-nav__submenu">
							...
							<li><a href="chart.php"><span>Monthly Report</span></a></li>
					...
					<li class="main-nav--collapsible">
						...
						<ul class="main-nav__submenu">
							<li><a href="user_account_report.php"><span>View Report</span></a></li>
						</ul>
					</li>
